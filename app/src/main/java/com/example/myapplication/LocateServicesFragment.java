...
public class LocateServicesFragment extends Fragment {

    private static final String ARG_PDF_PATH = "pdf_path"; // Key for PDF path argument
    private static final Logger logger = LoggerFactory.getLogger(LocateServicesFragment.class);

    public static LocateServicesFragment newInstance(String pdfPath) {
        LocateServicesFragment fragment = new LocateServicesFragment();
